...
ÚLTIMA MUDANÇA: Atualização da lista de serviços e adição da flag global EXIBIR_DETALHES.
DATA E HORA: 09 de Setembro de 2026, 22:32
VERSÃO: 14.0
=========================================================
*/
...
const SERVICOS = [
    ...
    },
    {
        ...
        detalhes: [
            "Configuração da rede conforme necessidade do usuário.",
    ...
    },
    {
        ...
        detalhes: [
            ...
            "Organização visando duralidade e qualidade."
        ]
    },
    {
        categoria: "software",
        ...
        detalhes: [
            ...
            "Solução de problema sem abrir mão do seu conforto."
        ]
    },
    {
        categoria: "hardware",
        ...
        exige_dispositivo: true,
        detalhes: [
            "Teste dedicados e corretos para cada componente.",
    ...
    },
    {
        ...
        detalhes: [
            ...
            "Instalação completa de drivers para a aplicação do usuário."
        ]
    },
    {
        categoria: "software",
        ...
        exige_dispositivo: true,
        detalhes: [
            "Formatação completa e limpeza de partições.",
    ...
    },
    {
        ...
        exige_dispositivo: true,
        detalhes: [
            "Remoção de sujidades e obstruções nos componentes.",
            "Limpeza técnica visando o cuidado com o funcionamento de cada componente.",
            "Aplicação de condutor térmico de alta qualidade."
        ]
    },
    {
        categoria: "dados",
        ...
        detalhes: [
            ...
            "Configuração da rede segundo a necessidade do usuário.",
            "Teste de comunicação entre todos os dispositivos."
        ]
    },
    {
        categoria: "hardware",
        ...
        exige_dispositivo: true,
        detalhes: [
            "Dimensionamento correto do seu setup com base em detalhes técnicos.",
            "Construção focada em qualidade dos componentes e estética de organização.",
            "Teste rigoroso de inicialização do funcionamento do setup."
        ]
    },
    {
        categoria: "software",
        ...
        exige_dispositivo: true,
        detalhes: [
            "Desativação de sistemas ocultos na inicialização.",
            "Remoção de arquivos que geram queda no desempenho do equipamento.",
            "Ajuste fino de efeitos visuais com foco em fluidez."
        ]
    },
    {
        categoria: "dados",
        ...
        exige_dispositivo: true,
        detalhes: [
            "Análise correto do dispositivo com ferramentas dedicadas.",
            "Restauração de diversos tipos de arquivos.",
    ...
    },
    {
        ...
        detalhes: [
            ...
            "Eliminação de extensões maliciosas no dispositivo.",
    ...
    },
    {
        ...
        exige_dispositivo: true,
        detalhes: [
            "Abertura técnica do dispositivo.",
            "Troca do componente por um de qualidade e com alta durabilidade.",
            "Reconfiguração da BIOS de forma correta."
        ]
    },
    {
        categoria: "hardware",
    ...
    },
    {
        ...
        exige_dispositivo: true,
        detalhes: [
            "Desconexão segura de todos os componentes.",
            "Remoção da unidade danificada.",
            "Instalação da nova fonte com dimensionamento correto e organização dos cabos."
        ]
    },
    {
        categoria: "hardware",
    ...
    },
    {
        ...
        exige_dispositivo: true,
        detalhes: [
            "Verificação técnica de compatibilidade.",
            "Limpeza dos slots com o produto correto.",
            "Instalação física buscando o melhor funcionamento."
        ]
    },
    {
        categoria: "hardware",
        ...
        exige_dispositivo: true,
        detalhes: [
            "Encaixe seguro no barramento correto.",
            "Instalação dos cabos auxiliares.",
            "Download e atualização dos drivers oficiais do dispositivo."
        ]
    },
    {
        categoria: "hardware",
